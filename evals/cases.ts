...
const automationExerciseTestCases: AutomationExerciseTestCase[] = [
  ...
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC12 add products cart" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}"}'`,
      `{browser} --session {session} open ${automationExerciseUrl}/products`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/products"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"ALL PRODUCTS"},"intent":"all products visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector(".features_items .productinfo a.add-to-cart[data-product-id=\\"1\\"]"); if (!el) throw new Error("product 1 add missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":[".features_items .productinfo a.add-to-cart[data-product-id=\\"1\\"]"],"intent":"add first product to cart"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":"#cartModal.show"},"intent":"first cart modal visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#cartModal.show .close-modal"); if (!el) throw new Error("continue shopping missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#cartModal.show .close-modal"],"intent":"continue shopping"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector(".features_items .productinfo a.add-to-cart[data-product-id=\\"2\\"]"); if (!el) throw new Error("product 2 add missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":[".features_items .productinfo a.add-to-cart[data-product-id=\\"2\\"]"],"intent":"add second product to cart"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":"#cartModal.show"},"intent":"second cart modal visible"}'`,
      ...
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#product-1 .cart_description h4 a","text":"Blue Top"},"intent":"first cart product name"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#product-2 .cart_description h4 a","text":"Men Tshirt"},"intent":"second cart product name"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC13 product quantity" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}/product_details/1`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/product_details/1"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".product-information h2","text":"Blue Top"},"intent":"product detail visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#quantity"); if (!el) throw new Error("quantity missing"); el.focus(); el.value = "4"; el.dispatchEvent(new Event("input", { bubbles: true })); el.dispatchEvent(new Event("change", { bubbles: true })); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"fillBySelector","args":["#quantity","4"],"intent":"set quantity to four"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector(".product-information button.cart"); if (!el) throw new Error("cart button missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":[".product-information button.cart"],"intent":"add quantity four to cart"}'`,
      ...
      `{browser} --session {session} open ${automationExerciseUrl}/view_cart`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/view_cart"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#product-1 .cart_description h4 a","text":"Blue Top"},"intent":"cart product name"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#product-1 .cart_quantity button","text":"4"},"intent":"cart product quantity four"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#product-1 .cart_total .cart_total_price","text":"Rs. 2000"},"intent":"cart product total"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  ...
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC18 category products" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":"#accordian.category-products"},"intent":"categories visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#accordian a[href=\\"#Women\\"]"); if (!el) throw new Error("Women category missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#accordian a[href=\\"#Women\\"]"],"intent":"expand Women category"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#Women a[href=\\"/category_products/2\\"]"); if (!el) throw new Error("Women Tops missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#Women a[href=\\"/category_products/2\\"]"],"intent":"open Women Tops category"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step assert '{"kind":"url","args":["/category_products/2"],"intent":"Women Tops URL reached"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".features_items h2.title","text":"Women - Tops Products"},"intent":"Women Tops heading visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#accordian a[href=\\"#Men\\"]"); if (!el) throw new Error("Men category missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#accordian a[href=\\"#Men\\"]"],"intent":"expand Men category"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#Men a[href=\\"/category_products/3\\"]"); if (!el) throw new Error("Men Tshirts missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#Men a[href=\\"/category_products/3\\"]"],"intent":"open Men Tshirts category"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step assert '{"kind":"url","args":["/category_products/3"],"intent":"Men Tshirts URL reached"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".features_items h2.title","text":"Men - Tshirts Products"},"intent":"Men Tshirts heading visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC19 brand products" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}/products`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/products"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".brands_products","text":"Brands"},"intent":"brands sidebar visible"}'`,
      `{browser} --session {session} click 'a[href="/brand_products/Polo"]'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["a[href=\\"/brand_products/Polo\\"]"],"intent":"open Polo brand"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step assert '{"kind":"url","args":["/brand_products/Polo"],"intent":"Polo brand URL reached"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".features_items h2.title","text":"Brand - Polo Products"},"intent":"Polo heading visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":".features_items a[href^=\\"/product_details/\\"]"},"intent":"Polo products visible"}'`,
      `{browser} --session {session} click 'a[href="/brand_products/H&M"]'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["a[href=\\"/brand_products/H&M\\"]"],"intent":"open H&M brand"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step assert '{"kind":"url","args":["/brand_products/H&M"],"intent":"H&M brand URL reached"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":".features_items h2.title","text":"Brand - H&M Products"},"intent":"H&M heading visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":".features_items a[href^=\\"/product_details/\\"]"},"intent":"H&M products visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  ...
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC21 product review" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}/product_details/1`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/product_details/1"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"Write Your Review"},"intent":"review section visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#name"); if (!el) throw new Error("name field missing"); el.focus(); el.value = "Agent QA"; el.dispatchEvent(new Event("input", { bubbles: true })); el.dispatchEvent(new Event("change", { bubbles: true })); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"fillBySelector","args":["#name","Agent QA"],"intent":"enter review name"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#email"); if (!el) throw new Error("email field missing"); el.focus(); el.value = "agent-qa-review@example.com"; el.dispatchEvent(new Event("input", { bubbles: true })); el.dispatchEvent(new Event("change", { bubbles: true })); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"fillBySelector","args":["#email","agent-qa-review@example.com"],"intent":"enter review email"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#review"); if (!el) throw new Error("review field missing"); el.focus(); el.value = "Great practice product review"; el.dispatchEvent(new Event("input", { bubbles: true })); el.dispatchEvent(new Event("change", { bubbles: true })); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"fillBySelector","args":["#review","Great practice product review"],"intent":"enter review text"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector("#button-review"); if (!el) throw new Error("review button missing"); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#button-review"],"intent":"submit product review"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"Thank you for your review."},"intent":"review success visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC22 recommended cart" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector(".recommended_items"); if (!el) throw new Error("recommended items missing"); el.scrollIntoView({ block: "center" }); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"RECOMMENDED ITEMS"},"intent":"recommended items visible"}'`,
      `{browser} --session {session} eval '(() => { const el = document.querySelector(".recommended_items a.add-to-cart[data-product-id]"); if (!el) throw new Error("recommended add-to-cart missing"); el.dispatchEvent(new MouseEvent("mousedown", { bubbles: true, cancelable: true, view: window })); el.dispatchEvent(new MouseEvent("mouseup", { bubbles: true, cancelable: true, view: window })); el.click(); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":[".recommended_items a.add-to-cart[data-product-id]"],"intent":"add recommended product to cart"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":"#cartModal.show"},"intent":"cart modal visible"}'`,
      `{browser} --session {session} open ${automationExerciseUrl}/view_cart`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}/view_cart"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step assert '{"kind":"url","args":["/view_cart"],"intent":"cart URL reached"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selector","selector":"#cart_info tbody tr[id^=\\"product-\\"]"},"intent":"recommended product row visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  ...
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC25 scroll up arrow" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}"}'`,
      `{browser} --session {session} eval '(() => { document.querySelector("#footer").scrollIntoView({ block: "center" }); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#footer .single-widget h2","text":"Subscription"},"intent":"subscription footer visible"}'`,
      `{browser} --session {session} click '#scrollUp'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step action '{"method":"clickSelector","args":["#scrollUp"],"intent":"click scroll up arrow"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"Full-Fledged practice website for Automation Engineers"},"intent":"top hero text visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
    ],
  },
  {
    ...
    fastPath: [
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} start "TC26 scroll up no arrow" --session {session}`,
      `{browser} --session {session} open ${automationExerciseUrl}`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step navigation '{"route":"${automationExerciseUrl}"}'`,
      `{browser} --session {session} eval '(() => { document.querySelector("#footer").scrollIntoView({ block: "center" }); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"selectorText","selector":"#footer .single-widget h2","text":"Subscription"},"intent":"subscription footer visible"}'`,
      `{browser} --session {session} eval '(() => { window.scrollTo(0, 0); return true; })()'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} record-step wait '{"condition":{"kind":"text","text":"Full-Fledged practice website for Automation Engineers"},"intent":"top hero text visible"}'`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} flush`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} verify`,
      `AGENT_QA_SCENARIOS_DIR={scenarios} AGENT_QA_RECORD_DIR={record} {qa} replay <sid> --session {session}-replay`,
